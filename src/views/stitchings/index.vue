...
<v-row>
    <v-col cols="12">
        <v-row class="mt-3">
            <v-col cols="12" class="">
                <v-card title="Stitchings" subtitle="View All Stitchings List" class="">
                    <v-card-text>
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { title: "Employe", value: "department" },
                { title: "Lot", value: "lot" },
                { title: "Item", value: "product" },
    ...
    methods: {
        async loadItems() {
            ...
            try {
                ...
                let res = await this.userStore.getList("stitching",this.filter);
                console.log(res);
        ...
        download(){
            this.themeStore.exportToExcel("stitching",this.items);
        }
