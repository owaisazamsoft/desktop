...
<v-row>
    <v-col cols="12">
        <v-row class="mt-3">
            <v-col cols="12" class="">
                <v-card title="Depratment" subtitle="View All Depratments List" class="">
                    <v-card-text>
    ...
    methods: {
        async loadItems() {
            ...
            try {
                ...
                let res = await this.userStore.getList("departments",this.filter);
                console.log(res);
        ...
        download(){
            this.themeStore.exportToExcel("departments",this.items);
        }
